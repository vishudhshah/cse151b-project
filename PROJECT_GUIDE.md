...
See **[`DATAHUB_GUIDE.md`](DATAHUB_GUIDE.md)** for the complete step-by-step guide covering:
- SSH into DSMLP and launching a GPU node
- Setting up git credentials on a fresh pod
- Installing dependencies with uv
- Keeping jobs alive with tmux
- Running all experiments and checking results mid-run
